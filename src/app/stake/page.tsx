      ...
      <Card className="p-0 max-w-sm w-full shadow-none border-none">
        ...
        >
          ...
          <CardHeader className="p-4">
            <CardTitle className=" font-bold text-xl">Stake bTokens</CardTitle>
            <br />
            <CardTitle className=" font-semibold">bToken</CardTitle>
            <SelectToken />
            <CardTitle className=" font-semibold">Amount</CardTitle>
            <Input type="number" min={0} placeholder="Input amount" />
          </CardHeader>
          <CardFooter className="p-4 border-t border-border [.border-t]:pt-4">
            <Button className="w-full bg-blue-600 hover:bg-blue-400">Stake</Button>
          </CardFooter>
        </MagicCard>
      </Card>
    </div>
