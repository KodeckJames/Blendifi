  ...
  return (
    ...
    >
      <div className="flex size-full max-w-lg flex-row items-stretch justify-between gap-10">
        ...
        <div className="flex flex-col justify-center">
          <Circle ref={div6Ref} className="size-16 bg-blue-600">
           <Image src={'/images/blendify_logo.png'} alt="blendify_logo" height={60} width={60} className=" rounded-full" quality={100}/>
        ...
        <div className="flex flex-col justify-center gap-2">
          <Circle ref={div1Ref}>
            <div className={`w-12 h-12 rounded-full flex items-center justify-center `}>
                    <span className="text-blue-600 font-bold text-sm">{token1.name}</span>
                  </div>
          </Circle>
          <Circle ref={div2Ref}>
             <div className={`w-12 h-12 rounded-full flex items-center justify-center `}>
                    <span className="text-purple-600 font-bold text-sm">{token2.name}</span>
                  </div>
          </Circle>
          <Circle ref={div3Ref}>
            <div className={`w-12 h-12 rounded-full flex items-center justify-center `}>
                    <span className="text-green-600 font-bold text-sm">{token3.name}</span>
                  </div>
          </Circle>
          <Circle ref={div4Ref}>
            <div className={`w-12 h-12 rounded-full flex items-center justify-center `}>
                    <span className="text-black font-bold text-sm">{token4.name}</span>
                  </div>
          </Circle>
          <Circle ref={div5Ref}>
            <div className={`w-12 h-12 rounded-full flex items-center justify-center `}>
                    <span className="text-orange-600 font-bold text-sm">{token5.name}</span>
                  </div>
          </Circle>
        </div>
      </div>
